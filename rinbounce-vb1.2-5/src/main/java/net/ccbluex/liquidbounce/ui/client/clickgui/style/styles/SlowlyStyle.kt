...
object SlowlyStyle : Style() {
    override fun drawPanel(mouseX: Int, mouseY: Int, panel: Panel) {
        drawBorderedRect(
            panel.x, panel.y - 3, panel.x + panel.width, panel.y + 17, 3, Color(42, 57, 79).rgb, Color(42, 57, 79).rgb
        )
    ...
    override fun drawModuleElementAndClick(
        ...
        val backgroundColor = Color(7, 152, 252)
        ...
        drawRect(
            ...
            moduleElement.y + moduleElement.height + 1,
            getHoverColor(
                Color(7, 152, 252, moduleElement.slowlyFade), moduleElement.hoverTime, !moduleElement.module.isActive
            )
        )
