...
import net.ccbluex.liquidbounce.ui.client.hud.element.elements.target.NguyenTuanAnhxNoodAFK
...
class Target : Element("Target") {
    private val targetHudStyle by choices("Style", arrayOf("LiquidBounce", "NguyenTuanAnhxNoodAFK", "RavenB4"), "NguyenTuanAnhxNoodAFK")
    ...
    override fun drawElement(): Border {
        ...
        assumeNonVolatile {
            val style = when (targetHudStyle.lowercase()) {
                ...
                "rinbounce" -> NguyenTuanAnhxNoodAFK(
                    roundedRectRadius,
                    borderStrength,
                    backgroundColor,
                    healthBarColor1,
