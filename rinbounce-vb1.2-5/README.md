...
- [NguyenTuanAnhxNoodAFK Website](https://rinbounce.wtf/download)
...
2. Download the NguyenTuanAnhxNoodAFK jar file and put it in .minecraft/mods folder.

3. Launch Minecraft with the Forge profile.

## Contributing

NguyenTuanAnhxNoodAFK is an open-source project under the [GNU General Public License 3.0 License](https://www.gnu.org/licenses/gpl-3.0.html). If you want to contribute, feel free to fork the repository and submit pull requests.
